...
export declare type GraphQLResponseResolver<QueryType, VariablesType> = (req: GraphQLMockedRequest<VariablesType>, res: ResponseComposition<any>, context: GraphQLMockedContext<QueryType>) => AsyncResponseResolverReturnType<MockedResponse>;
export declare type GraphQLJSONRequestPayload<VariablesType> = {
    query: string;
    variables?: VariablesType;
};
export declare type GraphQLMultipartRequestPayload = {
    operations: string;
    map?: string;
} & Record<string, File | undefined>;
export declare type GraphQLRequestPayload<VariablesType> = GraphQLJSONRequestPayload<VariablesType> | GraphQLMultipartRequestPayload;
