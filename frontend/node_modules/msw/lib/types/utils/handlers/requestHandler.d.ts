...
export declare const defaultContext: {
    ...
    set: typeof set;
    delay: (durationOrMode?: number | "real" | "infinite" | undefined) => import("../../response").ResponseTransformer<any>;
    fetch: (input: string | MockedRequest<DefaultRequestBodyType, RequestParams>, requestInit?: RequestInit) => any;
};
export declare type DefaultMultipartBodyType = Record<string, string | File | (string | File)[]>;
export declare type DefaultRequestBodyType = Record<string, any> | DefaultMultipartBodyType | string | undefined;
