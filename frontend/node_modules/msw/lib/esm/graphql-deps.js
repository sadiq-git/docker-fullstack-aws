import { a as set, s as status, d as delay, f as fetch, j as jsonParse } from './fetch-deps.js';
import { d as data, e as errors } from './errors-deps.js';
import { m as matchRequestUrl, d as prepareRequest, e as prepareResponse, f as getTimestamp, h as getStatusCodeColor, b as getCallFrame } from './getCallFrame-deps.js';
            ...
            switch (req.method) {
                ...
                case 'POST': {
                    ...
                    if ((_b = req.body) === null || _b === void 0 ? void 0 : _b.operations) {
                        ...
                        const { operationType, operationName } = parseQuery(parsedOperations.query, expectedOperationType);
                        const files = others;
                        let variables;
                        try {
...
export { __awaiter as _, graphqlContext as a, graphql as g, parse as p };
